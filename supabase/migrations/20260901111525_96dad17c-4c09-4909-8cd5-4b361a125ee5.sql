...
grant all on public.rh_topups to service_role;
...
drop policy if exists rh_employees_no_direct_access on public.rh_employees;
drop policy if exists rh_topups_no_direct_access on public.rh_topups;
