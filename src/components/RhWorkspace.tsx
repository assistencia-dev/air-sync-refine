 ...
 * A sessão do gestor já autenticada no portal é o acesso administrativo do RH.
 * Não existe login, senha ou usuário administrativo separado para este módulo.
 */
    ...
    <div className="space-y-5">
      <div className="flex flex-col gap-4 rounded-2xl border border-slate-800 bg-[#1E293B] p-5 shadow-sm sm:flex-row sm:items-center sm:justify-between sm:px-7">
        <div>
          ...
          <h1 className="mt-1 text-xl font-black tracking-tight text-slate-50">RH — Benefícios, cadastro e ponto</h1>
          <p className="mt-1 text-xs text-slate-400">Sua sessão atual é o acesso do gestor RH. Os logins dos colaboradores são criados por você na Folha de Ponto.</p>
        </div>
        <div className="flex flex-col items-start gap-2 sm:items-end">
          ...
          {embedded && <span className="inline-flex items-center gap-1.5 text-[11px] font-bold text-emerald-300"><Shield className="h-3.5 w-3.5" /> Sessão única do RH · gestor autenticado</span>}
        </div>
      </div>
